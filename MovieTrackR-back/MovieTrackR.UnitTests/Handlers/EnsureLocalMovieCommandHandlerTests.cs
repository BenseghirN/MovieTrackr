...
public class EnsureLocalMovieCommandHandlerTests
{
    ...
    public async Task Returns_movieId_when_provided_locally()
    {
        ...
        Movie movie = Movie.CreateNew("Interstellar", null, null, 2014, null, null, null, null, 120, "Test", new DateTime(2014, 1, 1), null);
        db.Movies.Add(movie);
    ...
    public async Task Should_return_existing_local_id_and_not_import_when_tmdbid_already_in_db()
    {
        ...
        Movie existing = Movie.CreateNew("Inception", 27205, "Inception", 2010, null, null, null, null, 148, "dream", new DateTime(2010, 7, 16), null);
